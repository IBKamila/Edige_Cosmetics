    ...
    <footer>
      ...
      <div className="footer-section">
        <div className="footerInfos">
          ...
          <a href="">
            <img src={icons} alt="icons.png" />
          </a>
        </div>
        <div className="footerInfos" id="footerNavigation">
          <h3 className="footerTitle">Navigation</h3>
          <ul className="footerLists">
            <li className="navLi">
              <a className="navli_a" href="#">
                Product catalog
              </a>
            </li>
            <li className="navLi">
        ...
        <div className="footerInfos" id="footerProducts">
        ...
        <div className="footerCont">
          ...
          <div className="footer_cont">
            <span className="cont_li">
              {" "}
              <a href="">
                <img className="cont_icons" src={email} alt="email_icon" />
              </a>
              E-mail
            </span>
            <span>
              {" "}
              <a href="">
                <img className="cont_icons" src={whats} alt="whats_logo" />
              </a>
              Whatsapp
            </span>
          </div>
